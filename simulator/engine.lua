...
function dy(a,c,u)return aS(av(c,a),u)end
...
ay(357)for d,n in Y(T)do
for f,r in Y(T)do
if d~=f and(n[10]>0 or r[10]>0 or n[11]>0 or r[11]>0)and bv(n[1],r[1])<=n[13]+r[13]then
for V,J in Y(n[9])do
...
aJ=bo(bM)cE=aU(n,p,aJ)+aU(r,p,aJ)cb=aS(bN/cE,bm*.5)aX(n,p,g(aJ,-cb))aX(r,p,g(aJ,cb))end
bS=z[2]/b_
...
for d=1,#b[7]do
e=b[7][d]e[3]=h(e[2],dA)e[4]=bs(e[3],dz)bu=e[3]e[7]=aN(bu[1]^2+bu[2]^2+bu[3]^2)e[5]={e[4][1]*bg/e[4][3],-e[4][2]*bg/e[4][3]}e[6]=e[4][3]>0 and 1 or 0
end
for d=1,#b[8]do
